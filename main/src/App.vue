<template>
  <div>
    ...
    <el-button type="primary" size="default" @click="$router.push('/app2')">/app2</el-button>
    <el-button type="primary" size="default" @click="$router.push('/app2/about')">/app2/about</el-button>
  </div>
</template>
